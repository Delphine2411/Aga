...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 w-full z-50 bg-[#0b0c10]/80 backdrop-blur-md border-b border-blue-500"
    >
            ...
            <AnimatePresence>
              {showLangMenu && (
                <motion.div
                  ...
                  className="absolute right-0 mt-2 w-40 bg-gray-900 border border-blue-500 rounded-xl shadow-xl overflow-hidden"
                >
                  {languages.map((lang) => (
                    <motion.button
                      key={lang.code}
